...
<body>    
    ...
    <div id="main-menu">    
        ...
        <a href="answer.jsp" title="Отвветы"> Ответ</a>  |
...
<form action="video.jsp" method="post">              
    ...
    <div class="feed">
        <h3 aligin="center">Медиа-материалы</h3>     
        <%
            ArrayList<Video> list = EntityManager.getVids();
            for (Video v : list){
                //out.println("<div class=\"message\">");
                out.println("<p class=\"message\">");
                out.println(v.getVid_Name() + "<br/>");
                out.println("<a href=\"" + v.getVid_Path() + "\"> Ссылка на документ</a>");
                out.println("<br/>");
                out.println("</p>");                
                out.println("<hr/>");
                //out.println("<div>");                
